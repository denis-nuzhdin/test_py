class Contact:
    ...
    def __init__(self, c_firstname, c_middlename, c_lastname, c_nickname, c_title, c_company, c_address, c_home, c_mobile, c_work, c_fax, c_email, c_email2, c_email3, c_homepage, c_byear, c_ayear, c_address2, c_phone2, c_notes):
